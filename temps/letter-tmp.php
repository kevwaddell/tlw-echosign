...
include_once('../inc/doc_reader.php');
...
<body>
	...
	<div class="container">
		...
		<?php include_once('../inc/html/letter-steps-btns.php');?>
		
			<div class="letter-outer">
				
				<?php include_once('../inc/html/letter-logo.php');?>	
				...
				<?php 
					...
					include_once('../inc/pdf-parts/pdf-header.php');
					include_once('../inc/pdf-parts/pdf-footer.php');
			...
			<?php include_once('../inc/html/letter-disabled-btns.php');?>
			
			<?php include_once('../inc/html/letter-disabled-message.php');?>
...
<?php include_once('../inc/html/letter-modal-sigpad.php');?>

<?php } ?>

<?php if (isset($_GET['tkn']) && $_GET['tkn'] == $data[tkn]) { ?>

<?php include_once('../inc/html/letter-modal-step1.php');?>
<?php include_once('../inc/html/letter-modal-step2.php');?>
<?php include_once('../inc/html/letter-modal-step3.php');?>
<?php include_once('../inc/html/letter-modal-step4.php');?>
<?php include_once('../inc/html/letter-modal-step5.php');?>
